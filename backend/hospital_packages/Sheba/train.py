...
# dataset_path = "/opt/ml/input/data/training"  # default SageMaker input
# # upload_urls = config["upload_urls"]  -- Local backup disabled
...
# ───────────────────────────────────────
# Upload Artifacts to Local Director
# ───────────────────────────────────────
...
#             print(f"[UPLOAD] {file_path} → {upload_url} [{response.status_code}]")
#     except Exception as e:
#         print(f"[ERROR] Failed to upload {file_path} to {upload_url}: {e}")

# for url in upload_urls:
#     upload_file("model.pt", url)
#     upload_file("scaler.pkl", url)
#     upload_file("train.log", url)
